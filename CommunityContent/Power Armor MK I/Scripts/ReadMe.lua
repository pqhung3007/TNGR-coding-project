--[[Hello!
	My name is Antropy, I created this suit using the StarHopper Costume by WitcherSilver, which he built off of riffraff's system.
	Updates:
	
	v3: Added a template to work with the D&D Framework
	v2: Replaced missing ReadMe file, updated tooltips.
	v1: Release
